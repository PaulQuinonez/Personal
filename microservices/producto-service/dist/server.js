...
const producto_1 = require("./src/routes/producto");
const categoria_1 = require("./src/routes/categoria");
...
class Server {
    ...
    routes() {
        this.app.use(this.paths.productos, producto_1.api);
        this.app.use(this.paths.categorias, categoria_1.api);
    }
    listen() {
