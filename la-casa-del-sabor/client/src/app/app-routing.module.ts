...
const routes: Routes = [
  ...
  {path: 'receta-especial', component: RecetaEspecialIndexComponent},
  ...
  {path: 'recetaEspecial/registro', component: RecetaEspecialCreateComponent},
  {path: 'recetaEspecial/editar/:id', component: RecetaEspecialEditComponent},
  {path: 'recetaEspecial/view/:id', component: RecetaEspecialViewComponent},
