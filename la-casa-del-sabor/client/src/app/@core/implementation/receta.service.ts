...
export class RecetaService {
  ...
  postReceta(data:any) : Observable<any> {
    ...
    return this._http.post(this.url + 'receta', data, {headers : headers})
  }
  ...
  getRecetas() : Observable<any> {
    ...
    return this._http.get(this.url + 'receta', {headers : headers})
  }
  ...
  patchRecetas(data : any) : Observable<any> {
    ...
    return this._http.patch(this.url + 'receta/' + data._id, data, {headers : headers})
  }
  ...
  removeRecetas(id : any) : Observable<any> {
    ...
    return this._http.delete(this.url + 'receta/' + id, {headers : headers})
  }
